...
public class TestPurchaseProductController {
	...
	public void testPurchaseProducts() throws Exception {
		...
		ResultActions resultActions = mockMvc.perform(post(
				APIRequestMappings.PURCHASE_PRODUCT)
				.param("customerGuid", "3432uerwerw").param("cardId", "3371")
				.param("productId", "1223").param("productName", "Sweater")
				.param("productDescription", "black sweater")
				.param("productType", "woolen clothes")
				.param("amount", "1.00"));
